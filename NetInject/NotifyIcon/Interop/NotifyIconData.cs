namespace NetInject.NotifyIcon.Interop {
    ...
    public struct NotifyIconData {
        ...
        /// <summary>
        ///     ImageState of the icon. Remember to also set the <see cref="StateMask" />.
        /// </summary>
        public IconState IconState;
        /// <summary>
        ///     A value that specifies which bits of the state member are retrieved or modified.
        ///     For example, setting this member to <see cref="NetInject.NotifyIcon.Interop.IconState.Hidden" />
        ...
        ///     of the tray icon. If this member is non-NULL and the <see cref="NetInject.NotifyIcon.Interop.BalloonFlags.User" />
